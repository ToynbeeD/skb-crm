# Итоговая работа до курсу Javascript(базовый)

Данная CRM является итоговой работой по учебной программе в Skillbox на курсе Frontend-разработки.

crm-backend написан полностью командой Skillbox (не мной!).

Для создания frontend не использовались ни сборщики, ни препроцессоры.

Инструменты: html, css, js

Библиотеки: ChoicesJs, TippyJs
